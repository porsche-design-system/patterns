...
Error: expect(page).toHaveScreenshot(expected)
  ...
  69965 pixels (ratio 0.28 of all image pixels) are different.

Expected: /opt/repository/tests/vrt/specs/__screenshots__/header-1-iphone-15.png
Received: /opt/repository/tests/vrt/test-results/header-1.vrt.ts-has-no-visual-regression-header-1-default-iphone-15/header-1-actual.png
    Diff: /opt/repository/tests/vrt/test-results/header-1.vrt.ts-has-no-visual-regression-header-1-default-iphone-15/header-1-diff.png
...
Call log:
  ...
  - fonts loaded
  - 70102 pixels (ratio 0.28 of all image pixels) are different.
